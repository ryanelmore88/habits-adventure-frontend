        ...
        <div className="App">
            ...
            <div className="diceButtonList">
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'2d20kh1'</span>
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'3d20kh1'</span>
                <span className="exp">Roll '3d20' keeping the highest of the three</span>
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'4d6dl1'</span>
                <span className="exp">
          ...
          attributes.
                ...
                <span className="diceNotation">'8d6!'</span>
                <span className="exp">
          ...
          Roll '10d10' and count up the number of rolls that are 7 or greater
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'1d8+1d8+1d6'</span>
                <span className="exp">
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'1d100&lt;60'</span>
                <span className="exp">
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'1d100&lt;(60/2)'</span>
                <span className="exp">
                ...
                <AdvRollBtn
                    ...
                    onRoll={rollDice}
                />
                <span className="diceNotation">'1d100&lt;(60/5)'</span>
                <span className="exp">
